...
public class FreeDrawingManager : MonoBehaviour
{
    ...
    // brushColor with the inspector-controlled opacity baked into the alpha channel
    private Color BrushColorWithOpacity =>
    ...
    void StartStroke(Vector3 startPos)
    {
        ...
        Color c = BrushColorWithOpacity;
        currentStroke.startColor = c;
        currentStroke.endColor = c;
